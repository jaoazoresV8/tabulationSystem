...
<body class="bg-background-primary h-screen w-screen p-4 flex items-center justify-center overflow-hidden">
    ...
    <div class="tactical-frame w-full h-full max-w-[1700px] max-h-[950px] z-10">

        <!-- HEADER / SYSTEM STATUS -->
        <header class="h-20 border-b border-border flex items-center justify-between px-10 shrink-0 bg-background-secondary/50 relative">
            <div class="flex items-center gap-12">
                <div class="flex items-center gap-6">
                    <div class="w-10 h-10 bg-accent flex items-center justify-center -skew-x-12">
                        <span class="text-white font-bebas text-2xl skew-x-12">V</span>
                    </div>
                    <div>
                        <h1 class="text-3xl tracking-[0.2em] leading-none mb-1">CCDI</h1>
                        <div class="text-[9px] font-mono text-text-secondary tracking-[0.4em] uppercase">Operations Interface</div>
                    </div>
                </div>
                ...
                <div class="hidden lg:flex gap-10 border-l border-border pl-12 h-10 items-center">
                    <div class="flex flex-col">
                        ...
                        <span class="text-[10px] font-mono text-success uppercase tracking-widest animate-pulse">â— Online // Operational</span>
                    </div>
                    <div class="flex flex-col">
            ...
            <div class="flex items-center gap-8">
                ...
                <div class="flex flex-col text-right">
                    ...
                    <span id="admin-station-clock" class="text-xs font-mono text-text-primary tracking-widest uppercase">00:00:00 AM</span>
                </div>
                <div class="h-10 w-10 border border-border bg-panel p-1 flex items-center justify-center">
        ...
        <div class="flex-1 flex overflow-hidden">
            ...
            <!-- SIDEBAR -->
            <aside class="w-72 border-r border-border bg-background-secondary/30 flex flex-col shrink-0">
                <div class="px-8 pt-10 pb-4">
                    <div class="text-[10px] font-mono text-accent uppercase tracking-[0.4em] mb-8 opacity-70">Main Systems</div>
                </div>
            ...
            <!-- MAIN CONTENT AREA -->
            <main class="flex-1 overflow-y-auto custom-scrollbar bg-background-primary/10 relative p-10">
                {{ $slot }}
            </main>

            <!-- Workspace Right Panel (Optional) -->
            @if(isset($rightPanel))
            <aside class="w-96 border-l border-border bg-background-secondary/50 shrink-0 overflow-y-auto custom-scrollbar">
                {{ $rightPanel }}
            </aside>
            @endif
        </div>
        ...
        <!-- FOOTER / STATUS BAR -->
        <footer class="h-10 border-t border-border bg-background-secondary flex items-center px-10 justify-between shrink-0 relative z-20">
            <div class="flex gap-10">
                <div class="flex items-center gap-3 text-[9px] font-mono text-text-secondary tracking-widest uppercase">
            ...
            <div class="text-[9px] font-mono text-text-secondary tracking-widest uppercase">
